    ...
    socket.on("message", (data) => {
        ...
        switch (parsed.id) {
            ...
            case "connect":
                ...
                if (containerInfo === null || containerInfo === void 0 ? void 0 : containerInfo.length) {
                    ...
                    docker = (0, node_pty_1.spawn)("docker", ["run", "--name", parsed.data.label, "--entrypoint", "/bin/bash", "--hostname", parsed.data.label, "-it", parsed.data.image], {
                        name: "computercraft",
                        cols: parsed.data.width,
                        rows: parsed.data.height,
                    });
